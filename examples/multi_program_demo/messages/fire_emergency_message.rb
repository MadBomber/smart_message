...
module Messages
  ...
  class FireEmergencyMessage < SmartMessage::Base
    ...
    property :house_address, required: true, description: "Full street address of the house where fire was detected"
    ...
    property :timestamp, required: true, description: "Exact time when the fire was first detected (YYYY-MM-DD HH:MM:SS format)"
    property :occupants_status, description: "Current safety status of people in the house (safe/evacuated/trapped/rescued)"
    property :spread_risk, description: "Assessment of fire's potential to spread to neighboring structures"
  end
end